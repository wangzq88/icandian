...
class MessageController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','index','view','delete'),
				'users'=>array('@'),
			),
	...
	public function actionIndex()
	{
		...
		$sql = "SELECT SQL_CALC_FOUND_ROWS * FROM ".Message::model()->tableName()." WHERE receive_uid=$uid AND flag=1 ORDER BY id DESC LIMIT $start,$limit";
