<div id="myCarousel_<?php echo $cat['categories_id'];?>" class="carousel slide">
    <div class="carousel-inner" style="overflow:visible;">
    <?php $i = 0;?>
    <?php foreach($food_list as $food):?>
 		<?php if($cat['categories_id'] == $food['categories_id']):?>
			<?php if($i%FOOD_PAGE_COUNT == 0):?>
                <?php 
					if($i != 0):
                         echo '</ul></div>';
                 	endif;
	...
	<a class="carousel-control left" style="left:5px;" href="#myCarousel_<?php echo $cat['categories_id'];?>" data-slide="prev">&lsaquo;</a>
	<a class="carousel-control right" style="right:5px;" href="#myCarousel_<?php echo $cat['categories_id'];?>" data-slide="next">&rsaquo;</a>
</div>